      ...
      <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          ...
          <div className="flex flex-col sm:flex-row gap-2 flex-shrink-0">
            ...
            <button 
              onClick={() => window.open(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000'}/api/employees/${employee.id}/resume`, '_blank')}
              className="flex items-center gap-1.5 px-4 py-2 text-xs font-medium border border-border text-foreground rounded-lg hover:bg-surface transition-colors"
            >
